...
public class C02_ZeroTest {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        //3. Login alanina  “username” yazdi
        ...
        driver.findElement(By.id("sp_amount")).sendKeys("18000");
        ...
        WebElement actalyTitle=driver.findElement(By.id("alert_content"));

        if(actalyTitle.isDisplayed()) {
